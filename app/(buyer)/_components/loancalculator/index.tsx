      ...
      <div className="w-full  bg-primary-100 rounded-3xl p-6">
        ...
        <div className="bg-white rounded-2xl p-6 mb-6">
          <div className="flex gap-2">
            ...
            <div className="mb-6 w-full">
              <label className=" w-full block text-sm font-medium text-gray-600 mb-2">Loan Term</label>
          ...
          <button onClick={handleGetEstimate} className="w-fit bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200">
        ...
        <div className="mb-6 text-xs text-gray-700 leading-relaxed">
          <span className="font-semibold">Please note:</span> Actual loan terms, rates, and approvals are determined by
          our lending partners and dealers. Estimates provided are for informational purposes only and may not include
          additional fees such as title, registration, or taxes. Final terms may vary based on your credit profile and
          lender requirements.
        </div>
        ...
        <div className="bg-white rounded-2xl p-6">
          <div className="flex justify-between items-center">
            ...
            <button onClick={() => router.push(`/loan-vehicle/${vehicleId}`)} className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-full transition-colors duration-200">
              Apply for loan
            </button>
          </div>
        </div>
