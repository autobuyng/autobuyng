  ...
  const onSubmit = (data: TermsAndConditions) => {
    ...
    const finalData = {
      ...
      employmentInformation: {
        ...
        directorsBVN: formData.employmentInformation.directorsBVN,
        directorsFirstName: formData.employmentInformation.directorsFirstName,
        directorsLastName: formData.employmentInformation.directorsLastName,
