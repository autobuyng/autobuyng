            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col">
                ...
                <input
                  id="businessName"
                  type="text"
                  {...register("businessName", { required: hasSideBusiness ? "Business name is required" : false })}
              ...
              <div className="flex flex-col">
                ...
                <select
                  id="businessType"
                  {...register("businessType", { required: hasSideBusiness ? "Business type is required" : false })}
              ...
              <div className="flex flex-col">
                ...
                <input
                  id="directorsBVN"
                  type="text"
                  {...register("directorsBVN", { required: hasSideBusiness ? "Directors BVN is required" : false })}
                  className={`px-3 py-2 border rounded-md text-sm transition-colors ${errors.directorsBVN ? "border-red-500" : "border-gray-300"
                    } focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500`}
                />
                {errors.directorsBVN && (
              ...
              <div className="flex flex-col">
                <label htmlFor="directorsFirstName" className="font-medium text-gray-700 mb-2 text-sm">
                ...
                <input
                  ...
                  className={`px-3 py-2 border rounded-md text-sm transition-colors ${errors.directorsFirstName ? "border-red-500" : "border-gray-300"
                    } focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500`}
                />
                {errors.directorsFirstName && (
                  <span className="text-red-500 text-xs mt-1">{errors.directorsFirstName.message}</span>
                )}
              </div>

              <div className="flex flex-col">
                <label htmlFor="directorsLastName" className="font-medium text-gray-700 mb-2 text-sm">
                  Directors Last Name *
                </label>
                <input
                  ...
                  className={`px-3 py-2 border rounded-md text-sm transition-colors ${errors.directorsLastName ? "border-red-500" : "border-gray-300"
                    } focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500`}
                />
                {errors.directorsLastName && (
                  <span className="text-red-500 text-xs mt-1">{errors.directorsLastName.message}</span>
                )}
              </div>
            </div>
          </div>
