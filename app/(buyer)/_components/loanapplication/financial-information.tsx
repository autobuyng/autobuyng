      ...
      <form onSubmit={handleSubmit(onNext)} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col">
            ...
            <input
              ...
              className={`px-3 py-2 border rounded-md text-sm transition-colors ${errors.monthlyExpenses ? "border-red-500" : "border-gray-300"
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className={`px-3 py-2 border rounded-md text-sm transition-colors ${errors.existingLoans ? "border-red-500" : "border-gray-300"
                } focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500`}
            />
            {errors.existingLoans && <span className="text-red-500 text-xs mt-1">{errors.existingLoans.message}</span>}
          </div>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className={`px-3 py-2 border rounded-md text-sm transition-colors ${errors.bankName ? "border-red-500" : "border-gray-300"
              } focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500`}
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col">
            ...
            <input
              ...
              className={`px-3 py-2 border rounded-md text-sm transition-colors ${errors.accountNumber ? "border-red-500" : "border-gray-300"
                } focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500`}
            />
          ...
          <div className="flex flex-col">
            ...
            <select
              ...
              className={`px-3 py-2 border rounded-md text-sm transition-colors ${errors.accountType ? "border-red-500" : "border-gray-300"
                } focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500`}
            >
              <option value="Savings">Savings</option>
              <option value="Checking">Checking</option>
            </select>
            {errors.accountType && <span className="text-red-500 text-xs mt-1">{errors.accountType.message}</span>}
          </div>
        </div>
