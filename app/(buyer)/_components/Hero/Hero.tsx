      ...
      <div className="w-full h-full sm:min-h-[90vh] md:h-screen absolute top-0 md:top-8 z-10 bg-black/50 md:bg-transparent ">
        <div className=" w-full sm:max-w-[1336px] md:px-6 mx-auto h-screen md:h-[83vh] relative flex items-start md:items-center justify-center ">
          <video
            ...
            muted
            color="bg-black/50"
            className=" w-full h-[35vh] md:h-full object-cover md:rounded-[30px] bg-opacity-50"
          />

          <div className=" absolute left-0 top-0 flex flex-col md:flex-row items-center justify-center w-full h-full sm:gap-8">
            <div className=" absolute top-6  w-full md:w-fit h-full sm:static    md:ml-12 sm:mr-0 flex items-center justify-center sm:justify-start order-2 md:order-1">
              <HomeSearch />
            </div>
